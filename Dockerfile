...
WORKDIR /app                                 # we have created a directory in Docker named app and we are using it as work directory 
...
EXPOSE 9696                                  # We need to expose the 9696 port because we are not able to communicate with Docker outside it
